...
libraryDependencies += "com.github.ghostdogpr"        %% "caliban-http4s"  % "0.5.1"
...
libraryDependencies += "org.http4s"                   %% "http4s-blaze-client"           % "0.21.0"
libraryDependencies += "org.http4s"                   %% "http4s-dsl"                    % "0.21.0"
